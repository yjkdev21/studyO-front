    ...
    const fetchStatistics = async () => {
      ...
      try {
        ...
        const categoryResponse = await axios.get(
          `${host}/api/admin/statistics/categories`,
          {
        ...
        const regionResponse = await axios.get(
          `${host}/api/admin/statistics/regions`,
          {
            withCredentials: true,
            params: filters,
          }
        ...
        const monthlyResponse = await axios.get(
          `${host}/api/admin/statistics/monthly`,
          {
            withCredentials: true,
            params: filters,
          }
  ...
  if (loading) {
    return (
      <div className="admin-board">
        <AdminSidebar initialTab={currentTab} onMenuClick={handleMenuClick} />
